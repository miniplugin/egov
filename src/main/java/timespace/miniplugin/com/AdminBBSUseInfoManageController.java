 ...
 */
@Controller
public class AdminBBSUseInfoManageController {
     ...
     * @throws Exception
     */
    @RequestMapping("/admin/common/deleteBBSUseInf.do")
    public String deleteBBSUseInf(@ModelAttribute("searchVO") BoardUseInfVO bdUseVO, @ModelAttribute("bdUseInf") BoardUseInf bdUseInf,
		...
		return "forward:/admin/common/selectBBSUseInfs.do";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/admin/common/insertBBSUseInf.do")
     ...
     * @throws Exception
     */
    @RequestMapping("/admin/common/selectBBSUseInfs.do")
    public String selectBBSUseInfs(@ModelAttribute("searchVO") BoardUseInfVO bdUseVO, ModelMap model) throws Exception {
		...
		return "admin/common/BoardUseInfList";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/admin/common/updateBBSUseInf.do")
     ...
     * @throws Exception
     */
    @RequestMapping("/admin/common/selectBBSUseInf.do")
	...
	BoardUseInfVO vo = bbsUseService.selectBBSUseInf(bdUseVO);
		...
		if ("SYSTEM_DEFAULT_BOARD".equals(vo.getTrgetId())) {
		    if (vo.getBbsTyCode().equals("BBST02")) {	// 익명게시판
		    	...
		    	vo.setProvdUrl("/main/template_start/Board.do?bbsId=" + vo.getBbsId());
		    }
		}

		model.addAttribute("bdUseVO", vo);
		return "admin/common/BoardUseInfUpdt";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/admin/common/selectBBSUseInfsByTrget.do")
    public String selectBBSUseInfsByTrget(@ModelAttribute("searchVO") BoardUseInfVO bdUseVO, ModelMap model) throws Exception {
		...
		return "admin/common/BdUseInfListByTrget";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/admin/common/updateBBSUseInfByTrget.do")
    public String updateBBSUseInfByTrget(@ModelAttribute("searchVO") BoardUseInfVO bdUseVO, @ModelAttribute("boardUseInf") BoardUseInf boardUseInf,
		...
		return "forward:/admin/common/selectBBSUseInfsByTrget.do";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/admin/common/insertBBSUseInfByTrget.do")
