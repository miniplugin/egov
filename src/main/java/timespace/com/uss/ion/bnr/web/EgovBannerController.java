...
package timespace.com.uss.ion.bnr.web;
...
import timespace.com.utl.fcc.service.EgovStringUtil;
import egovframework.rte.fdl.idgnr.EgovIdGnrService;
import egovframework.rte.ptl.mvc.tags.ui.pagination.PaginationInfo;
import timespace.com.uss.ion.bnr.service.Banner;
...
public class EgovBannerController {
    ...
    @RequestMapping(value="/admin/bnr/selectBannerList.do")
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/admin/bnr/getBanner.do")
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/admin/bnr/addViewBanner.do")
	...
	@RequestMapping(value="/admin/bnr/addBanner.do")
...
//	    	return "admin/bnr/EgovBannerUpdt";
	 ...
	 */
    @SuppressWarnings("unused")
	@RequestMapping(value="/admin/bnr/updtBanner.do")
	public String updateBanner(final MultipartHttpServletRequest multiRequest,
		...
		if (bindingResult.hasErrors()) {
			...
			//	    	return "forward:/admin/bnr/getBanner.do";
			return "forward:/admin/bnr/selectBannerList.do";
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/admin/bnr/removeBanner.do")
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/admin/bnr/removeBannerList.do")
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value="/admin/bnr/getBannerImage.do")
	public String selectBannerResult(@ModelAttribute("bannerVO") BannerVO bannerVO,
		...
		return "admin/bnr/EgovBannerView";
	}
    ...
    @RequestMapping(value="/admin/bnr/selectBannerMainList.do")
	public String selectBannerMainList(@ModelAttribute("bannerVO") BannerVO bannerVO,
		...
		return "admin/bnr/EgovBannerMainList";
	}
}
