...
<script type="text/javascript">
    ...
    function fn_egov_regist_notice(){
        ...
        if (confirm('<spring:message code="common.update.msg" />')) {
            document.board.action = "<c:url value='/main/sample_menu${prefix}/updateEgovDownload.do'/>";
		...
		<!-- //좌측메뉴 끝 -->			
			...
			<div id="content">
				...
				<div class="bodytext_area box_inner">
					...
					<input type="hidden" name="returnUrl" value="<c:url value='/main/sample_menu/forUpdateEgovDownload.do'/>"/>
