...
<html>
  <head>
    ...
    <![endif]-->
  <style>.main-footer{text-align:center; margin:0 auto;}</style>
  </head>
      <!-- jQuery 2.1.4 -->
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs"><c:out value="${loginName}"/></span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      <c:out value="${loginName}"/><small></small>
                    </p>
                  </li>
                  <!-- Menu Body 
                  <li class="user-body">
