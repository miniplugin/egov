...
function fnIdCheck(){
    var retVal;
    var url = "<c:url value='/admin/member/IdDplctCnfirmView.do'/>";
    var varParam = new Object();
    varParam.checkId = document.mberManageVO.mberId.value;
    var openParam = "dialogWidth:303px;dialogHeight:350px;scroll:no;status:no;center:yes;resizable:yes;";
...
<section class="content">
	<div class="row">
		...
		<form:form commandName="mberManageVO" name="mberManageVO" action="${pageContext.request.contextPath}/admin/member/MberInsert.do" method="post" >
			...
			<div class="box-body">
				<div class="form-group col-sm-12">
					<label class="col-sm-3" for="mberId">회원아이디<img src="<c:url value='/'/>images/required.gif" alt="필수항목" title="필수항목" /></label>
					
					<input class="col-sm-3" type="text" maxlength="20" disabled="disabled" id="id_view" name="id_view" >
                    <form:input path="mberId" id="mberId" title="일반회원아이디" size="20" cssClass="txaIpt" readonly="true" maxlength="20" cssStyle="display:none"/>
                    <a class="col-sm-6" href="#LINK" onclick="fnIdCheck();">
				...
				<div class="form-group col-sm-6">
					...
					<input class="col-sm-6" name="mberNm" id="mberNm" title="일반회원이름" type="text" value="" maxlength="60" />
				</div>
				
				<div class="form-group col-sm-6">
					<label class="col-sm-6" for="password">비밀번호<img src="<c:url value='/'/>images/required.gif" alt="필수항목" title="필수항목" /></label>
					
					<form:password cssClass="col-sm-6" path="password" id="password" title="비밀번호" maxlength="20" />
                    <form:errors path="password" cssClass="error" />
				</div>
				<div class="form-group col-sm-6">
					<label class="col-sm-6" for="password2">비밀번호확인<img src="<c:url value='/'/>images/required.gif" alt="필수항목" title="필수항목" /></label>
					
					<input class="col-sm-6" name="password2" id="password2" title="비밀번호확인" type="password" maxlength="20" />
				</div>
				<div class="form-group col-sm-6">
			...
			<div class="box-footer">
                ...
                <!-- 등록 -->
                <input class="btn btn-warning" type="submit" value="<spring:message code="button.save" />" onclick="fnInsert(); return false;" />
                <!-- 목록 -->
