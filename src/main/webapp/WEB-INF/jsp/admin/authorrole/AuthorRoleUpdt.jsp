...
function fncAuthorRoleUpdate() {
    var varFrom = document.getElementById("authorRole");
    varFrom.action = "<c:url value='/admin/authorrole/updtAuthorRole.do'/>";
...
<section class="content">
	<div class="row">
		...
		<div class="col-md-12">
			...
			<form:form commandName="authorRole" method="post" action="${pageContext.request.contextPath}/admin/authorrole/updtAuthorRole.do' />">
       		<input type="hidden" name="authorRoleId" value="<c:out value='${authorRole.authorRoleId}'/>" />
			<div class="box-body">
				...
				<div class="form-group col-sm-6">
                   ...
                   --%>
                   <form:select path="authorCode" id="authorCode" cssClass="form-control">
			...
			<div class="box-footer">
				...
				<ul class="mailbox-attachments clearfix uploadedList">
				 ...
				 <input class="btn btn-primary" type="submit" value="<spring:message code="button.save" />" onclick="fncAuthorRoleUpdate(); return false;" />
				 ...
				 <a class="btn btn-default" href="<c:url value='/admin/authorrole/removeAuthorRole.do'/>?authorRoleId=<c:out value='${authorRoleVO.authorRoleId}'/>" onclick="fncAuthorRoleDelete(); return false;"><spring:message code="button.delete" /></a>
			</div>
			<!-- 검색조건 유지 -->
